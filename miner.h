...
extern boulderhash_ctx *create_boulderhash_ctx(threadpool_t *pool);
extern void destroy_boulderhash_ctx(boulderhash_ctx *ctx);
extern int scanhash_boulderhash(int thr_id, uint32_t *pdata, const uint32_t *ptarget,
